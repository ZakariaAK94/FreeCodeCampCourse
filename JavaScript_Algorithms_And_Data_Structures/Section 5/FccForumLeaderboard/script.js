...
const forumCategory = (id) => {
  ...
  const url = `${forumCategoryUrl}${selectedCategory.className}/${id}`; // e.g: "https://forum.freecodecamp.org/c/""html-css"423  
...
const timeAgo = (time) => 
{
  ...
  const timeDifference = currentTime - lastPost; // result is in ms
